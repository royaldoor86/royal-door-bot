...
class _RewardsPageState extends State<RewardsPage>
                        ...
                        child: StreamBuilder<List<ActiveReward>>(
                          ...
                          builder: (context, rewardsSnapshot) {
                            ...
                            double dailyGems = activeRewards.fold(
                              0,
                              (prev, item) => prev + item.dailyReward,
                            );
                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            _buildStatisticsCard(userData.uid),
                                            const SizedBox(height: 20),
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  "تعرف على كيفية مضاعفة مكافآتك الملكية",
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  "عرض تاريخ مكافآتك الملكية السابقة",
                  style: TextStyle(color: Colors.white38, fontSize: 11),
                ),
              ],
            ),
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  "عرض إجمالي مكافآتك الملكية منذ البداية",
                  style: TextStyle(color: Colors.white38, fontSize: 11),
                ),
              ],
            ),
          ...
          child: FutureBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              if (docs.isEmpty) {
                return const Center(
                  child: Text(
                    'لا توجد بيانات مكافآت ملكية بعد',
              ...
              return SingleChildScrollView(
                child: Column(
                  children: [
                    _statItem(
                      'إجمالي المكافآت',
                      _formatNumber(totalHarvest),
                      Icons.account_balance_wallet,
                      Colors.greenAccent,
                    ),
                    _statItem(
                      'عدد مرات المكافآت',
                      harvestCount.toString(),
                      Icons.history,
                      Colors.blueAccent,
                    ),
                    _statItem(
                      'أعلى مكافأة',
                      _formatNumber(maxHarvest),
                      Icons.trending_up,
                      Colors.amber,
                    ),
                    _statItem(
                      'متوسط المكافآت',
                      _formatNumber(avgHarvest),
                      Icons.analytics,
                      Colors.purpleAccent,
                    ),
                    const SizedBox(height: 20),
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  "تفعيل تنبيهات قبل وقت المكافآت الملكية",
                  style: TextStyle(color: Colors.white38, fontSize: 11),
                ),
              ],
            ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'تفعيل التنبيهات الذكية سيقوم بإرسال إشعار قبل انتهاء وقت المكافآت الملكية بـ 30 دقيقة.',
              style: TextStyle(color: Colors.white70),
            ),
            const SizedBox(height: 20),
            const Text(
            ...
            _notificationFeature(
              'تنبيه قبل 30 دقيقة من وقت المكافآت الملكية',
              Icons.timer,
            ),
            _notificationFeature(
              'تنبيه قبل 1 ساعة من وقت المكافآت الملكية',
              Icons.access_time,
            ),
            _notificationFeature('تنبيه عند اقتراب وقت المكافآت', Icons.alarm),
          ],
        ),
        actions: [
          TextButton(
  ...
  Widget _buildMarketplacePromoCard() {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const RoyalRewardsMarketplacePage()),
      ),
      child: Container(
        margin: const EdgeInsets.symmetric(horizontal: 20),
        padding: const EdgeInsets.all(20),
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    "اعرض باقاتك للبيع أو اشترِ باقات بأسعار مميزة",
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      isWaiting ? "جاري التجهيز" : "جاهز للمكافآت الملكية",
                      style: TextStyle(
                        color: isWaiting ? Colors.white24 : Colors.greenAccent,
                        fontSize: 13,
                        fontWeight: FontWeight.bold,
                        shadows: [
                          Shadow(
                            color:
                                (isWaiting ? Colors.orange : Colors.greenAccent)
                                    .withValues(alpha: 0.5),
                            blurRadius: 5,
      ...
      if (totalHarvested > 0) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content:
                  Text('لا توجد مكافآت مستحقة حالياً أو تم استلامها مسبقاً'),
  ...
  Future<void> _purchase(String uid, Map<String, dynamic> plan) async {
    ...
    try {
      await _rewardsService.purchaseReward(
        ...
        dailyReward: ((plan['total'] as num) / 30).toDouble(),
        durationDays: 30,
        paymentMethod: 'gems',
      );
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              'لقد قمت بتفعيل باقة $name بنجاح.',
              textAlign: TextAlign.center,
              style: const TextStyle(color: Colors.white70),
            ),
            const SizedBox(height: 5),
            Text(
              'إجمالي النجوم: ${_formatNumber(total)}',
              style: const TextStyle(
                color: Colors.amber,
                fontWeight: FontWeight.bold,
                fontFamily: 'Orbitron',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 15),
            const Text(
              "هنا يمكنك تفعيل عداد المكافآت الملكية كل 24 ساعة لاستلام نمو النجوم من الباقات النشطة بالمزايا الملكية.",
              textAlign: TextAlign.center,
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text(
                  'حول رصيدك لأي مستخدم في المملكة فوراً',
                  style: TextStyle(color: Colors.white70, fontSize: 12),
                ),
                const SizedBox(height: 20),
                _giftField(
                  idController,
                  'الآيدي الملكي (Royal ID)',
                  Icons.person_search,
                ),
                const SizedBox(height: 15),
                _giftField(
                ...
                const SizedBox(height: 10),
                const Text(
                  'سيتم استقطاع 5% رسوم لدعم صندوق المملكة',
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text(
              'تم استلام المكافآت الملكية بنجاح! 🎉',
              style: TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.bold,
                fontFamily: 'Orbitron',
                    ...
                    return AnimatedCard(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            _buildAchievementIcon(icon, isUnlocked),
                            const SizedBox(height: 4),
                            Text(
                              title.length > 8
                                  ? '${title.substring(0, 8)}...'
  ...
  Widget _buildAchievementIcon(String icon, bool isUnlocked) {
    if (icon.length <= 2) {
      // It's an emoji
      return Text(
        icon,
      ...
      // It might be an icon name
      IconData iconData = Icons.emoji_events_outlined;
      if (icon == 'event_available') iconData = Icons.event_available;
      if (icon == 'workspace_premium') iconData = Icons.workspace_premium;
      if (icon == 'stars') iconData = Icons.stars;
      if (icon == 'diamond') iconData = Icons.diamond;

      return Icon(
        iconData,
        size: 32,
        color: isUnlocked ? Colors.amber : Colors.grey.withValues(alpha: 0.5),
      );
    }
  }
              ...
              children: [
                Row(
                  children: [
                    ...
                    if (!isVIP)
                      ElevatedButton(
                        onPressed: () => _showVIPPackagesDialog(),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.amber,
                          padding: const EdgeInsets.symmetric(
                            horizontal: 16,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          height: 400,
          child: ListView.builder(
            itemCount: VIPPackages.defaultPackages.length,
            itemBuilder: (context, index) {
              final package = VIPPackages.defaultPackages[index];
              return Container(
                margin: const EdgeInsets.only(bottom: 12),
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      package.levelColor.withValues(alpha: 0.2),
                      package.levelColor.withValues(alpha: 0.05),
                    ],
                  ),
                  borderRadius: BorderRadius.circular(15),
                  border: Border.all(
                    color: package.levelColor.withValues(alpha: 0.5),
                    width: 1,
                  ),
                ),
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          Navigator.pop(context);
                          await _purchaseVIPPackage(package);
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: package.levelColor,
                          padding: const EdgeInsets.symmetric(vertical: 12),
                        ),
                        child: const Text(
                          'شراء',
  ...
  Future<void> _purchaseVIPPackage(VIPPackage package) async {
    final user = FirebaseAuth.instance.currentUser;
    if (user == null) return;
    ...
    try {
      await VIPService.purchaseVIPPackage(user.uid, package);

      if (mounted) {
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('تم شراء ${package.name} بنجاح! 🎉'),
            backgroundColor: Colors.green,
          ),
        );
        setState(() {}); // Refresh UI
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final dailyReward =
                        (reward['dailyReward'] as num?)?.toDouble() ?? 0.0;
                    ...
                    final nextAvailable = lastRewardDate.add(
  ...
  Widget _buildTipsAndHintsCard() {
    final tips = [
      {
        'icon': '💎',
        'title': 'المكافآت الملكية اليومية',
        'description': 'احصل على مكافآتك الملكية كل 24 ساعة لزيادة أرباحك',
      },
      {
        'icon': '📦',
        'title': 'شراء الباقات',
  ...
  void _showTutorialDialog() {
    final tutorialSteps = [
      ...
      {
        'title': 'المكافآت الملكية اليومية',
        'description': 'احصل على مكافآتك الملكية كل 24 ساعة بعد مشاهدة الإعلان',
        'icon': '💎',
      },
      {
        'title': 'تحويل النجوم',
