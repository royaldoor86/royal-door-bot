                      ...
                      ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: (imageUrl.isNotEmpty &&
                                  Uri.tryParse(imageUrl)?.host.isNotEmpty ==
                                      true)
                              ? imageUrl
                              : '',
                          width: 45,
              ...
              children: [
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: (imageUrl != null &&
                            imageUrl!.isNotEmpty &&
                            Uri.tryParse(imageUrl!)?.host.isNotEmpty == true)
                        ? imageUrl!
                        : '',
                    width: 55,
                    height: 55,
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('الغرفة الصوتية الملكية 👑',
                          style: TextStyle(
        ...
        child: Row(
          ...
          children: [
            const Icon(Icons.insert_drive_file_rounded,
                color: DesignTokens.primaryGold, size: 30),
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      background: Container(
        alignment: isMe ? Alignment.centerRight : Alignment.centerLeft,
        padding:
            const EdgeInsets.symmetric(horizontal: DesignTokens.spacingXl2),
      ...
      child: GestureDetector(
        ...
        child: Container(
          color: widget.isSelected
              ? DesignTokens.primarySapphire.withValues(alpha: 0.2)
              : Colors.transparent,
          padding:
                  ...
                  child: GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: (widget.senderAvatar != null &&
                              ...
                              Uri.tryParse(widget.senderAvatar!)
                                      ?.host
                                      .isNotEmpty ==
                                  true)
