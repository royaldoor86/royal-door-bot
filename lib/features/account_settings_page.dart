  ...
  Future<void> _handleClearCache() async {
    ...
    showDialog(
      ...
      builder: (context) => RoyalConfirmDialog(
        title: trans.get('logout').contains('خروج')
        ...
        confirmLabel:
            trans.get('logout').contains('خروج') ? 'مسح الآن' : 'Clear Now',
                  ...
                  children: [
                    ...
                    _buildSettingCard(
                        ...
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const UsageStatisticsPage()))),
                    _buildSettingCard(
                        icon: Icons.link,
                        title: 'ربط الحسابات الاجتماعية',
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const SocialAccountsPage()))),
                    _buildSettingCard(
                    ...
                    _buildSettingCard(
                        ...
                        title: 'إعدادات الخصوصية المتقدمة',
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    _buildSettingCard(
                        ...
                        title: 'إعدادات الإشعارات المخصصة',
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) =>
                    ...
                    _buildSettingCard(
                        icon: Icons.mic,
                        title: 'إعدادات الغرف الصوتية',
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) =>
                                    const VoiceRoomSettingsPage()))),
