...
class _RedemptionPageState extends State<RedemptionPage> {
  ...
  final _detailsController =
      TextEditingController(); // تم تغيير المسمى من wallet
    ...
    try {
      ...
      await _auth.verifyPhoneNumber(
        ...
        verificationCompleted: (PhoneAuthCredential credential) {
          ...
          if (mounted) {
            ...
            AppTheme.showSuccessSnackbar(
                context, 'تم التحقق التلقائي بنجاح 🛡️');
          }
        },
        verificationFailed: (FirebaseAuthException e) {
          ...
          if (mounted) AppTheme.showErrorSnackbar(context, errorMsg);
        },
        codeSent: (String verificationId, int? resendToken) {
          ...
          if (mounted) {
            AppTheme.showSuccessSnackbar(
                context, 'تم إرسال رمز التحقق لهاتفك 🛡️');
          }
        },
  ...
  Future<void> _handleSubmit() async {
    ...
    setState(() => _isLoading = true);
    try {
      // التحقق من رمز OTP باستخدام Firebase Phone Auth
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (ctx) => RoyalConfirmDialog(
        ...
        message:
            'تم استلام طلب تحويل المزايا بنجاح. سيتم مراجعة البيانات من قبل الإدارة الملكية خلال 48 ساعة وتزويدكم بالقسيمة.',
        confirmLabel: 'فهمت',
        onConfirm: () {
            ...
            SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    const DisplayText('استرداد المزايا الملكية',
                        textAlign: ui.TextAlign.right),
                    const SizedBox(height: DesignTokens.spacingMd),
                    const BodyText(
                        'حول مزاياك إلى قسائم شراء وحصرية عبر شركائنا المعتمدين.'),
                    ...
                    _isLoading
                        ...
                        : RoyalButton(
                            label: _isOtpSent
                                ...
                                : 'طلب رمز الأمان',
                            onPressed:
                                _isOtpSent ? _handleSubmit : _handleSendOTP,
                          ),
        ...
        child: DropdownButton<String>(
          ...
          items: methods
              .map((m) => DropdownMenuItem(
                  value: m,
                  child: BodyText(m, color: Colors.white, fontSize: 13)))
              .toList(),
