...
class _RewardsStatsPageState extends State<RewardsStatsPage>
  ...
  Future<void> _loadStats() async {
    ...
    try {
      ...
      final packagesSnapshot = await _db
          .collection('users')
          .doc(user.uid)
          .collection('active_harvests')
      ...
      setState(() {
        _totalEarnedStars =
            (statsData['totalEarnedStars'] as num?)?.toDouble() ??
                (userData['harvest_stars_wallet'] as num?)?.toDouble() ??
                0.0;
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text('إحصائيات المملكة',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 18,
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                  child: _buildMiniStatCard(
                      "المكافآت الشهرية",
                      "${_format(_totalDailyYield * 30)} نجمة",
                      Icons.trending_up,
                      Colors.orangeAccent)),
            ],
          ),
          ...
          Row(
            children: [
              Expanded(
                  child: _buildMiniStatCard("الباقات المكتملة", "0",
                      Icons.check_circle_outline, Colors.greenAccent)),
              const SizedBox(width: 15),
              Expanded(
                  child: _buildMiniStatCard(
                      "الباقات النشطة",
                      _activePackages.toString(),
          ...
          _buildSectionHeader("تاريخ المكافآت الأخير", Icons.history),
          const SizedBox(height: 15),
          ...
          return Container(
            ...
            child: const Column(
              children: [
                ...
                SizedBox(height: 15),
                Text("لا توجد باقات نشطة حالياً",
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    ...
                    const Color(0xFF00251A).withValues(alpha: 0.3)
                  ],
                ),
                borderRadius: BorderRadius.circular(20),
                border:
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(reward.packageName,
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16)),
                            Text(
                                "ينتهي في: ${DateFormat('yyyy/MM/dd').format(reward.endTime)}",
                                style: const TextStyle(
                      ...
                      Column(
                        ...
                        children: [
                          Text("+${_format(reward.dailyReward)}",
                              style: const TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Text("المتبقي: ${reward.remainingDays} يوم",
                          style: const TextStyle(
                  ...
                  children: [
                    ...
                    Text(
                        ...
                        style: const TextStyle(
                            ...
                            fontFamily: 'Orbitron')),
                    const Spacer(),
                    Text("${_format(item['amount'] ?? 0)} نجمة",
                        style: const TextStyle(
                            color: Colors.amber,
                            fontWeight: FontWeight.bold,
                            fontSize: 13,
  ...
  Widget _buildHistory() {
    if (_history.isEmpty) {
      return const Center(
          child: Text("لا يوجد سجل حصاد حالياً",
            ...
            builder: (context, snapshot) {
              ...
              if (achievements.isEmpty) {
                return Container(
                  padding: const EdgeInsets.all(20),
                  child: const Text(
                      "لا توجد أوسمة محققة حالياً. استمر بالمكافآت!",
  ...
  Widget _buildLevelMap() {
    final levels = [
      ...
      {'name': 'ذهبي', 'stars': '500k', 'reached': _totalEarnedStars >= 500000},
      {
        'name': 'بلاتيني',
        'stars': '1M',
        'reached': _totalEarnedStars >= 1000000
      },
      {
        'name': 'خبير ملكي',
        'stars': '5M',
        'reached': _totalEarnedStars >= 5000000
      },
    ];
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Icon(isReached ? Icons.check : Icons.lock,
                        size: 15,
                  ...
                  children: [
                    Text(level['name'] as String,
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold,
                            fontSize: 16)),
                    Text("المتطلب: ${level['stars']} نجمة",
                        style: TextStyle(
                            color: isReached ? Colors.white54 : Colors.white24,
                            fontSize: 12,
                            fontFamily: 'Orbitron')),
                    const SizedBox(height: 25),
                  ],
  ...
  Widget _achievementItem(String id, String t, String d, bool done,
      {bool isClaimed = false, int reward = 0}) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(done ? Icons.emoji_events : Icons.lock_outline,
              color: done ? Colors.amber : Colors.white24),
          const SizedBox(width: 15),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text("تم استلام مكافأة الإنجاز بنجاح! 🎉"),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text("فشل في استلام المكافأة: $e"),
