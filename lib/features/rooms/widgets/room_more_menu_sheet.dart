...
''';
  ...
  void _showRoomStatistics() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => RoomStatisticsSheet(roomId: widget.roomId),
    );
  }

  void _showRoomUserRanking() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => RoomUserRankingSheet(roomId: widget.roomId),
    );
  }

  void _showCustomNotifications() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => CustomNotificationsSheet(roomId: widget.roomId),
    );
  }
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _buildGridItem(
                            Icons.leaderboard, 'تصنيف', Colors.indigo,
                            onTap: () {
                          Navigator.pop(context);
                          _showRoomUserRanking();
                        }),
                        _buildGridItem(
                            Icons.notifications, 'إشعارات', Colors.teal,
                            onTap: () {
                          Navigator.pop(context);
