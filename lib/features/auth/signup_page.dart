...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _signup() async {
    ...
    if (_calculateAge(_birthDate!) < 17) {
      _showSnack(
          "عذراً، يجب أن يكون عمرك 17 عاماً أو أكثر لاستخدام رويال دور 🛡️");
      return;
    }
    ...
    try {
      ...
      final bannedCheck = await FirebaseFirestore.instance
      ...
      if (bannedCheck.exists) {
        if (mounted) {
          _showSnack(
              "عذراً، هذا البريد الإلكتروني محظور من الانضمام لرويال دور نهائياً 🚫");
        ...
        if (ambassadorQuery.docs.isNotEmpty) {
          ...
          await FirebaseFirestore.instance.runTransaction((tx) async {
            tx.update(ambassadorRef, {
              ...
              'agentData.referralEarnings':
                  FieldValue.increment(5), // احتساب الجواهر كمكافأة ربح
            });
          ...
          NotificationsService.sendNotification(
            ...
            message:
                'لقد انضم صديقك ($name) عن طريقك. حصلت على 5 جواهر و 5 كوينز 💎💰',
                ...
                child: Column(
                  children: [
                    ...
                    _inputField(
                      ...
                      validator: (v) =>
                          (v == null || v.isEmpty) ? "يرجى إدخل الاسم" : null,
                    ),
                    ...
                    _isLoading
                        ...
                        : AppTheme.gradientButton(
                            text: 'إنشاء حساب ملكي جديد', onPressed: _signup),
    ...
    return AppTheme.glassContainer(
      ...
      child: Column(
        children: [
          ...
          const Text("عالم النخبة والمنافسة الملكية",
