  ...
  Future<void> _addStoreItem() async {
    ...
    try {
      ...
      if (_selectedType == 'hand_id' || _selectedType == 'hand_effect') {
        ...
        if (_selectedType == 'hand_id' && handNumber == null && handLetters == null) {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(value: 'perk', child: Text('ميزة للعائلة')),
                          DropdownMenuItem(
                              value: 'hand_id',
                              child: Text('إيديات (أرقام/حروف)')),
                          DropdownMenuItem(
                              value: 'hand_effect', child: Text('تأثير الإيديات')),
                          DropdownMenuItem(
                              value: 'entertainment',
                              child: Text('عنصر ترفيهي')),
                          DropdownMenuItem(value: 'badge', child: Text('شارة ملكية')),
                        ],
                        onChanged: (value) =>
                      ...
                      TextField(
                        ...
                        style: const TextStyle(color: Colors.white),
                        maxLines: 2,
                        decoration: _inputDeco('وصف العنصر', Icons.description),
                      ),
                      const SizedBox(height: 15),
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              style: const TextStyle(color: Colors.white),
                              decoration: _inputDeco('السعر الأساسي', Icons.payments),
                            ),
                          ),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: _inputDeco('سعر العرض (يخصم)', Icons.discount),
                            ),
                          ),
                        ],
                      ),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        style: const TextStyle(color: Colors.white),
                        dropdownColor: const Color(0xFF3D0B16),
                        decoration: _inputDeco('العملة المستخدمة', Icons.account_balance_wallet),
                        items: _selectedType == 'hand_id'
                            ? const [
                                DropdownMenuItem(
                                    value: 'family_gems',
                          ...
                          children: [
                            Expanded(
                              child: TextField(
                                ...
                                keyboardType: TextInputType.number,
                                style: const TextStyle(color: Colors.white),
                                decoration: _inputDeco('رقم الإيدي', Icons.numbers),
                              ),
                            ),
                            const SizedBox(width: 10),
                            Expanded(
                              child: TextField(
                                ...
                                style: const TextStyle(color: Colors.white),
                                decoration: _inputDeco('حروف الإيدي', Icons.abc),
                              ),
                            ),
                          ],
                        ),
                      ...
                      if (_selectedType == 'hand_effect')
                        TextField(
                          ...
                          style: const TextStyle(color: Colors.white),
                          decoration: _inputDeco('معرف التأثير (Effect ID)', Icons.auto_awesome),
                        ),
                      ...
                      if (_selectedType == 'perk')
                        TextField(
                          ...
                          keyboardType: TextInputType.number,
                          style: const TextStyle(color: Colors.white),
                          decoration: _inputDeco('المدة (بالأيام)', Icons.timer),
                        ),

                      // اختيار الصورة (فقط للأنواع التي تحتاج صورة)
                      if (_selectedType != 'hand_id') ...[
                        const SizedBox(height: 20),
                        const Text('تصميم العنصر:', style: TextStyle(color: Colors.white70, fontSize: 13)),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Icon(
                                          item['currency'] == 'family_gems' ? Icons.diamond : Icons.stars,
                                          size: 10,
                                          color: item['currency'] == 'family_gems' ? Colors.cyan : Colors.amber),
                                      ],
                                    ),
