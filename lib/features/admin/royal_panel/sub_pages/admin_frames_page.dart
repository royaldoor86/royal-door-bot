    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text('إدارة الإطارات الملكية',
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final frame = FrameModel.fromFirestore(docs[index]
  ...
  Widget _buildAddHeader() {
    return Container(
      ...
      child: ElevatedButton.icon(
        ...
        label: const Text('إضافة إطار ملكي جديد',
                ...
                Expanded(
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: accentGold.withValues(alpha: 0.2), width: 1),
                    ),
                    child: ClipOval(
                      child: Image.network(frame.imageUrl,
                          fit: BoxFit.cover,
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildOptionRow('إطار متحرك', isAnimated,
                    (v) => setModalState(() => isAnimated = v)),
                _buildOptionRow('إطار بروفايل', isProfileFrame,
                    (v) => setModalState(() => isProfileFrame = v)),
                _buildOptionRow('إطار عائلة', isFamilyFrame,
                    (v) => setModalState(() => isFamilyFrame = v)),
                const SizedBox(height: 10),
                Text('مستوى VIP الأدنى: $vipLevel',
                    style:
              ...
              ElevatedButton(
                onPressed: () async {
                  if (nameCtrl.text.isEmpty ||
                      (selectedFile == null && linkCtrl.text.isEmpty)) {
                    return;
                  }
                ...
                child: const Text('حفظ ونشر الإطار',
  ...
  Widget _buildOptionRow(String title, bool val, Function(bool) onChanged) {
    return Row(
      ...
      children: [
        ...
        Switch(value: val, onChanged: onChanged, activeThumbColor: accentGold),
      ],
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('لا توجد إطارات ملكية مضافة',
