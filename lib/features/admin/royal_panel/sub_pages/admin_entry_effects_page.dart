    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text('إدارة مؤثرات الشاشة الكاملة',
  ...
  Widget _buildAddHeader() {
    return Container(
      ...
      child: ElevatedButton.icon(
        ...
        label: const Text('إضافة مؤثر دخول جديد',
              ...
              children: [
                        ...
                        : Column(
                            ...
                            children: [
                              Icon(Icons.cloud_upload_outlined,
                                  color: accentGold, size: 50),
                              const Text('انقر لرفع ملف (GIF أو Lottie JSON)',
                                  style: TextStyle(
                ...
                if (isLoading)
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      if (nameCtrl.text.isEmpty ||
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text('الرجاء إكمال جميع البيانات')));
                        return;
                      }
                      ...
                      try {
                        ...
                        final ref = FirebaseStorage.instance.ref().child(
                            'entry_effects/${DateTime.now().millisecondsSinceEpoch}.$ext');
                        await ref.putFile(
                            pickedFile!,
                            SettableMetadata(
                                contentType: isLottie
                                    ? 'application/json'
                                    : 'image/gif'));
                    ...
                    child: const Text('نشر المؤثر في المتجر ✨',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('لا توجد تأثيرات دخول حالياً',
