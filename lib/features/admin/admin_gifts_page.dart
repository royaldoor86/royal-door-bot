...
class _AdminGiftsPageState extends State<AdminGiftsPage> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            _buildChoiceChip('صورة ثابتة', 'image', _giftType,
                                (v) => setModalState(() => _giftType = v)),
                            const SizedBox(width: 8),
                            _buildChoiceChip('فيديو', 'video', _giftType,
                                (v) => setModalState(() => _giftType = v)),
                          ],
                        ),
                        const SizedBox(height: 15),
                        ...
                        Row(
                          children: [
                            ...
                            ElevatedButton.icon(
                              onPressed: () =>
                                  _pickAndUploadFile(setModalState),
  ...
  Widget build(BuildContext context) {
    String title = widget.initialPlacement == 'room'
        ? "إدارة هدايا الغرف والماركت 👑"
        : "مصنع هدايا المحادثات 🎨";
    return Directionality(
      textDirection: TextDirection.rtl,
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (docs.isEmpty) {
              return const Center(
                  child: Text("لا توجد هدايا حالياً",
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              Row(children: [
                ...
                Icon(
                    data['currencyType'] == 'gems'
                        ? Icons.diamond
                        : Icons.stars,
                    size: 10,
                    color: Colors.amber)
              ]),
              Text("القسم: ${data['category'] ?? 'غير مصنف'}",
          ...
          trailing: Row(mainAxisSize: MainAxisSize.min, children: [
            IconButton(
                ...
                onPressed: () => _openGiftForm(gift: data, id: id)),
            IconButton(
