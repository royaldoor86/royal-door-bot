...
class _FamilyVotingPageState extends State<FamilyVotingPage> {
  ...
  void _addOption() {
    if (_optionsController.text.trim().isNotEmpty) {
      setState(() {
        _options.add(_optionsController.text.trim());
  ...
  Future<void> _createVote() async {
    ...
    if (_selectedType == 'multiple_choice' && _options.length < 2) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('يرجى إضافة خيارين على الأقل')),
      );
      return;
    }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: 'yes_no', child: Text('نعم/لا')),
                          DropdownMenuItem(
                              value: 'multiple_choice',
                              child: Text('متعدد الخيارات')),
                          DropdownMenuItem(
                              value: 'name_change',
                        ...
                        Wrap(
                          ...
                          children: _options.map((option) {
                            return Chip(
                              ...
                              onDeleted: () =>
                                  _removeOption(_options.indexOf(option)),
                            );
                          }).toList(),
                        ),
                        const SizedBox(height: 15),
