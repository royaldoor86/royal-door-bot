...
class _DailyRewardsPageState extends State<DailyRewardsPage>
  ...
  Future<void> _captureAndShareStreak() async {
    try {
      ...
      RenderRepaintBoundary? boundary = _streakKey.currentContext
      ...
      final ByteData logoData =
          await rootBundle.load('assets/app/app_icon.png');
      ...
      textPainter.paint(
        canvas,
        Offset(x - textPainter.width - 20,
            y + (logoHeight / 2) - (textPainter.height / 2)),
      );
      ...
      canvas.drawImageRect(
        watermarkLogo,
        Rect.fromLTWH(0, 0, watermarkLogo.width.toDouble(),
            watermarkLogo.height.toDouble()),
              ...
              children: [
                ...
                ShaderMask(
                  shaderCallback: (bounds) {
                    ...
                    final waveOffset =
                        math.sin(controller.value * 2 * math.pi) * 0.2;
