            ...
            children: [
              ...
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Colors.purpleAccent.withValues(alpha: 0.5), blurRadius: 10, spreadRadius: 1)
                  ],
                ),
              ),
            ],
  ...
  Widget _buildTaskCard(Map<String, dynamic> task) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDone ? Colors.green.withValues(alpha: 0.5) : (isLocked ? Colors.white.withValues(alpha: 0.05) : Colors.white.withValues(alpha: 0.1)), 
          width: isDone ? 2 : 1
        ),
      ),
      child: Row(
          ...
          Stack(
            ...
            children: [
              Container(
                width: 50, height: 50,
                decoration: BoxDecoration(
                  color: (isLocked ? Colors.grey : rewardColor).withValues(alpha: 0.1),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("الجائزة: ", style: TextStyle(color: Colors.white.withValues(alpha: 0.4), fontSize: 11)),
                    Text(task['desc'] ?? '', 
