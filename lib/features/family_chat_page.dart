...
class _FamilyChatPageState extends State<FamilyChatPage> {
  ...
  final Map<String, String> _roomNames = {
    ...
    'war': 'غرفة الحروب',
    'strategy': 'غرفة الاستراتيجية',
    'social': 'غرفة الاجتماعية',
  };
  ...
  void _sendMessage(UserModel user) async {
    ...
    await _db
      ...
      'replyTo':
          _replyTo != null ? {'text': _replyTo!.text, 'sender': 'عضو'} : null,
      'room': _selectedRoom,
      'reactions': {},
    });
    setState(() {
    ...
    return AppBar(
      ...
      title: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snap) {
          ...
          return Column(
            children: [
              Text(data?['name'] ?? 'دردشة العائلة',
                  style: const TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.bold)),
              const Text('الرسائل تُحذف تلقائياً عند الخروج 🛡️',
      ...
      actions: [
        IconButton(
          ...
          onPressed: () => _showPremiumFeatures(),
        ),
      ],
    );
  }
  ...
  Widget _buildRoomSelector() {
    return AppTheme.glassContainer(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: _roomNames.entries.map((entry) {
            ...
            return Padding(
              ...
              child: ChoiceChip(
                ...
                selected: isSelected,
                onSelected: (selected) {
                  setState(() => _selectedRoom = entry.key);
                },
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Dismissible(
              ...
              child: _buildMessageBubble(msg, data, isMe, docs[index].id),
            );
          },
        );
      },
  ...
  Widget _buildMessageBubble(MessageModel msg, Map<String, dynamic> data,
      bool isMe, String messageId) {
    final reactions = data['reactions'] as Map<String, dynamic>? ?? {};
    final reactionsList = reactions.values.toList();
            ...
            if (!isMe)
              CircleAvatar(
                ...
                backgroundImage: (data['senderPic'] != null &&
                        ...
                        Uri.tryParse(data['senderPic'].toString())
                                ?.host
                                .isNotEmpty ==
                            true)
  ...
  void _showPremiumFeatures() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF1A050E),
        title: const Text('الميزات المميزة 💎',
            style: TextStyle(color: Colors.amber)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _premiumFeature('🎤', 'الدردشة الصوتية', 'مكالمة صوتية مع الأعضاء'),
            _premiumFeature('📁', 'مشاركة الملفات', 'مشاركة الصور والمستندات'),
            _premiumFeature('🔔', 'إشعارات متقدمة', 'تخصيص الإشعارات'),
          ],
        ),
        actions: [
          TextButton(
  ...
  Widget _premiumFeature(String icon, String title, String description) {
    return Container(
          ...
          children: [
            IconButton(
              icon: Icon(Icons.emoji_emotions_outlined,
                  color: _showEmojiPicker ? Colors.amber : Colors.white54),
              onPressed: () =>
