...
class _UserChallengesPageState extends State<UserChallengesPage>
      ...
      flexibleSpace: FlexibleSpaceBar(
        background: Column(
          ...
          children: [
            ...
            const Text('الساحة الملكية للتحديات',
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 24,
                    fontWeight: FontWeight.bold)),
            Text('أكمل مهامك اليومية واحصد الجوائز 🏆',
                style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color:
              isSelected ? Colors.amber : Colors.white.withValues(alpha: 0.05),
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('حدث خطأ أثناء تحميل التحديات',
                      style: TextStyle(
        ...
        if (filteredDocs.isEmpty) {
          return const SliverFillRemaining(
              child: Center(
                  child: Text('لا توجد تحديات في هذا القسم حالياً',
  ...
  Widget _buildChallengeCard(
      QueryDocumentSnapshot<Map<String, dynamic>> doc, User? user) {
    final data = doc.data();
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            Text('التقدم: ${(value * 100).toInt()}%',
                style: const TextStyle(color: Colors.white24, fontSize: 10)),
            const Text('الجائزة: ${100} 🪙',
                style: TextStyle(
                    color: Colors.amber,
                    fontSize: 10,
                    fontWeight: FontWeight.bold)),
        ...
        try {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text('مبروك! تم استلام المكافأة الملكية 💰'),
                backgroundColor: Colors.green));
          }
        } catch (e) {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('حدث خطأ أو تم الاستلام مسبقاً')));
          }
        }
      },
