  ...
  static ThemeData themeData(
    ...
    switch (theme) {
      case 'ocean':
        ...
        surfaceColor = const Color(0xFF152238);
        accentColor = Colors.lightBlue;
        break;
      case 'forest':
        primaryColor = Colors.green;
        backgroundColor = const Color(0xFF0A1F0A);
        surfaceColor = const Color(0xFF152815);
        accentColor = Colors.lightGreen;
        break;
      case 'sunset':
        primaryColor = Colors.orange;
        backgroundColor = const Color(0xFF1F0A00);
        surfaceColor = const Color(0xFF281510);
        accentColor = Colors.deepOrange;
        break;
      case 'purple':
        primaryColor = Colors.purple;
        backgroundColor = const Color(0xFF1A0A2E);
        surfaceColor = const Color(0xFF2D1B4E);
        accentColor = Colors.purpleAccent;
        break;
      case 'royal':
      default:
        primaryColor = royalPink;
        backgroundColor = const Color(0xFF2D0B2D);
        surfaceColor = const Color(0xFF3D123D);
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor: isLight ? emeraldMain : backgroundColor,
      primaryColor: isLight ? emeraldLight : primaryColor,
      colorScheme: ColorScheme(
        brightness: isLight ? Brightness.light : Brightness.dark,
        primary: isLight ? emeraldLight : primaryColor,
        onPrimary: Colors.white,
        secondary: isLight ? Colors.white70 : accentColor,
        onSecondary: Colors.white,
        error: Colors.red,
        onError: Colors.white,
        surface: isLight ? emeraldSurface : surfaceColor,
...
class _RoyalFloatingParticles extends StatefulWidget {
  ...
  @override
  State<_RoyalFloatingParticles> createState() =>
      _RoyalFloatingParticlesState();
}
