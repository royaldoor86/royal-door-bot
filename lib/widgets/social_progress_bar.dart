...
class SocialProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SocialPointsModel?>(
      ...
      builder: (context, snapshot) {
        ...
        double progress = (currentCoins - levelStartPoints) / pointsPerLevel;
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  _buildPointsBadge(currentCoins),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  Text(
                    'الكوينز 🪙: $currentCoins',
                    style: const TextStyle(color: Colors.white70, fontSize: 12),
                  ),
                  Text(
                    'بقي ${levelEndPoints - currentCoins} كوينز 🪙 للمستوى ${currentLevel + 1}',
  ...
  Widget _buildEmptyState(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Text(
          'ابدأ بالتفاعل الاجتماعي لكسب الكوينز 🪙 الودية',
