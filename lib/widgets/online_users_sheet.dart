...
class OnlineUsersSheet extends StatefulWidget {
  final String roomId;

  const OnlineUsersSheet({super.key, required this.roomId});

  @override
  State<OnlineUsersSheet> createState() => _OnlineUsersSheetState();
}
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: AppTheme.royalGold.withValues(alpha: 0.2), width: 1),
        boxShadow: [
          BoxShadow(
              ...
              builder: (context, snapshot) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('الغرفة خالية حالياً',
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final onlineData =
                        onlineDocs[index].data() as Map<String, dynamic>;
