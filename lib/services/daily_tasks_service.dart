...
class DailyTasksService {
  ...
  static Stream<DocumentSnapshot<Map<String, dynamic>>> dailyTasksStream(
      String uid) {
  ...
  static Future<List<Map<String, dynamic>>> fetchTasksTemplate(
      {String lang = 'ar'}) async {
    try {
      final doc =
          await _firestore.collection('daily_tasks_templates').doc(lang).get();
      if (!doc.exists) {
        ...
        return data != null && data['tasks'] != null
    ...
    final List tasks = [
      {
        ...
        'tasks': [
          ...
          {
            'id': 'ad_task_2',
            'title': 'المهمة 2: كنز الياقوت',
            'desc': '5 مجوهرات زرقاء',
            'type': 'gem',
            'reward': 5,
            'isAd': true,
            'order': 2
          ...
          {
            'id': 'ad_task_4',
            'title': 'المهمة 4: جوهرة التاج',
            'desc': '7 مجوهرات زرقاء',
            'type': 'gem',
            'reward': 7,
            'isAd': true,
            'order': 4
          ...
          {
            'id': 'ad_task_6',
            'title': 'المهمة 6: الياقوت النادر',
            'desc': '10 مجوهرات زرقاء',
            'type': 'gem',
            'reward': 10,
            'isAd': true,
            'order': 6
          ...
          {
            'id': 'ad_task_8',
            'title': 'المهمة 8: ماسة الامبراطور',
            'desc': '12 مجوهرة زرقاء',
            'type': 'gem',
            'reward': 12,
            'isAd': true,
            'order': 8
          ...
          {
            'id': 'ad_task_10',
            'title': 'المهمة 10: الجائزة الكبرى',
            'desc': '20 خبرة XP',
            'type': 'xp',
            'reward': 20,
            'isAd': true,
