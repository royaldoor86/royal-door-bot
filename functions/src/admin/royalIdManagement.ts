...
/**
 * Checks if a user has super admin or owner role.
 * @param {string} uid User ID to check.
 * @return {Promise<boolean>} True if super admin or owner.
 */
...
/**
 * Ensures that a Royal ID is not already in use by another user.
 * @param {string} royalId The Royal ID to check.
 * @return {Promise<void>}
 */
...
/**
 * Creates an audit entry for a Royal ID change.
 * @param {string} uid The user ID.
 * @param {string | null} oldRoyalId The previous Royal ID.
 * @param {string} newRoyalId The new Royal ID.
 * @param {string} changedBy The ID of the user who made the change.
 * @param {string} changeType The type of change (e.g., "purchase").
 * @param {string} reason The reason for the change.
 * @return {object} The audit entry object.
 */
